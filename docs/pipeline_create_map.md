...
• Tường nằm trên CẠNH giữa 2 ô. Mỗi ô có walls = [Up, Right, Down, Left] với giá trị:
  0 = không tường, 1 = tường thường (chặn vĩnh viễn), 2 = tường biến mất (vỡ ngay khi
  rùa bước vào một trong hai ô kề cạnh đó).
